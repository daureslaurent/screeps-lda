...
class CityWorkerActionPickup extends _moduleCityWorker {
    /**
     *
    ...
    constructor(gameAccess, roomData) {
        super('CityWorkerActionPickup', roomData.room, gameAccess, roomData, 1, WorkerAction.PICKUP);
    }
    ...
    run(action) {
        ...
        if (site != null) {
            ...
            if (inRange) {
                ...
                const ret = action.creep.pickup(site);
...
module.exports = CityWorkerActionPickup;