...
const SysInterCityGroupTechTransport = require('sys/group/tech/TechTransport');

const USE_MEMORY = true;

class SysInterCityGroupModuleSendworker extends SysInterCityGroupTechTransport {
    /**
    ...
    constructor(roomOri, roomDataFactory, flagPos) {
        super(GroupType.SEND_WORKER, roomOri, roomDataFactory);
...
module.exports = SysInterCityGroupModuleSendworker;