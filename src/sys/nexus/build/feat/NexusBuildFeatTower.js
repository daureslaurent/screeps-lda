...
class NexusBuildFeatTower extends _nexusBuilderFeatSequential {
    /**
     * @param roomName {string}
     */
    constructor(roomName) {
        super('Tower', undefined, 3)
    ...
    onInitSequential(index, gameAccess, roomData, buildTemplate) {
        if (this.rawPos.length === 0) {
            this.rawPos = buildTemplate.getTower().slice();
        }
        ...
        this.endData.push(this.checkPosTerrainNotWall(pos, STRUCTURE_TOWER));
    }
...
module.exports = NexusBuildFeatTower;